...
public:
  ...
  // Method to generate a random number with a 1 - sqrt(1 - y) distribution
  double Es2_1();
  // Method to generate a Random angle [0, 2*PI)
  double Random_angle();
  // Method to generate a Random Walk on a lattice
  Posizione RandomWalk_lattice(Posizione &pos, double a);
  // Method to generate a Random Walk on a continuum
  Posizione RandomWalk_continuum(Posizione &pos, double a);
};
