...
int main (int argc, char *argv[]){
   ...
   ofstream out_cc("output_files/call_continuo.dat");
   ofstream out_pc("output_files/put_continuo.dat");
   ...
   for(int i=0; i<N; i++){          // ciclo sui blocchi
      ...
      out_cc << i << "\t\t" << ave_call << "\t\t" << error_call << endl;
      out_pc << i << "\t\t" << ave_put << "\t\t" << error_put << endl;

   }


   cout << "✅ Dati salvati in files output call_continuo.dat e put_continuo.dat" << endl;
